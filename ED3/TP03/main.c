...
int main ()
{
    ...
    case 9:
        scanf("%s %s %s", arq_pessoa, arq_indexa, arq_sOrdenado);
        func9(arq_pessoa, arq_indexa, arq_sOrdenado);
        break;

    case 10:  
        scanf("%s %s %s", arq_pessoa, arq_indexa, arq_sOrdenado);
        func10(arq_pessoa, arq_indexa, arq_sOrdenado); 
        break;    

    case 11:
        scanf("%s %s %s", arq_pessoa, arq_indexa, arq_sOrdenado);
        func11(arq_pessoa, arq_indexa, arq_sOrdenado);
        break;

    case 12:
        scanf("%s %s %s", arq_pessoa, arq_indexa, arq_sOrdenado);
        func12(arq_pessoa, arq_indexa, arq_sOrdenado);
        break;
