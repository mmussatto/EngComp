...
public class Game {
 ...
 /*----------------- Game Settings ---------------------------------------------------------------------------------------------------*/    
     ...
     * Esse método controla o loop do jogo em si. Quando o jogador perde, 
    ...
    public int GameLoop() {
        ...
        while(true){
            ...
            /*Aumenta Velocidade dos Invasores*/
